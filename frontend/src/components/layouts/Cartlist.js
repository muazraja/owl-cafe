        ...
        return (
            <Fragment>
                            ...
                            <div key={i} className="cart-sidebar-item">
                                <div className="media">
                                    ...
                                    <div className="media-body">
                                        ...
                                        <span>{item.qty}x AED {new Intl.NumberFormat().format((item.price).toFixed(2))}</span>
                                    </div>
                                </div>
                                ...
                                <div className="cart-sidebar-price">
                                    {new Intl.NumberFormat().format((item.price * item.qty).toFixed(2))}AED
                            </div>
                ...
                <div className="cart-sidebar-footer">
                    <h4>Total: <span>{new Intl.NumberFormat().format((priceTotal).toFixed(2))}AED</span> </h4>
