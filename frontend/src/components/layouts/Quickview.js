            ...
            <Fragment> 
                ...
                <Modal.Body>
                    <div className="customize-meta">
                        <h4 className="customize-title">{item.name} <span className="custom-primary">AED {new Intl.NumberFormat().format((item.price).toFixed(2))}</span> </h4>
                        <p>{item.shortdesc}</p>
                    </div>
                                    ...
                                    <div className="customize-variation-wrapper">
                                        ...
                                        {item.items.map((add, i) => (
                                            <div key={i} className="customize-variation-item">
                                                ...
                                                <span>+{new Intl.NumberFormat().format((add.addprice).toFixed(2))}AED</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
