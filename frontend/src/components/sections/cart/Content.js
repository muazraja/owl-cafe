                        ...
                        <tbody>
                            {cartitem.map((item, i) => (
                                <tr key={i}>
                                    ...
                                    <td data-title="Price"> <strong>AED {new Intl.NumberFormat().format((item.price).toFixed(2))}</strong> </td>
                                    ...
                                    <td data-title="Total"> <strong>{new Intl.NumberFormat().format((item.price * item.qty).toFixed(2))}AED</strong> </td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                        ...
                        <div className="offset-lg-6 col-lg-6">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <th>Subtotal</th>
                                        <td>{new Intl.NumberFormat().format((this.state.priceTotal).toFixed(2))}AED</td>
                                    </tr>
                                    <tr>
                                        <th>Tax</th>
                                    ...
                                    <tr>
                                        <th>Total</th>
                                        <td> <b>{new Intl.NumberFormat().format((this.state.priceTotal + tax).toFixed(2))}AED</b> </td>
                                    </tr>
                                </tbody>
                            </table>
