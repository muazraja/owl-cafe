...
const pizzamenu = bannerData.pizzamenu || [];
const pastamenu = bannerData.pastamenu || [];
                            ...
                            <div key={i} className="col-lg-6">
                                <div className="ct-mini-menu-item">
                                    <div className="ct-mini-menu-top">
                                        ...
                                        <span className="custom-primary">AED {new Intl.NumberFormat().format((item.price).toFixed(2))}</span>
                                    </div>
